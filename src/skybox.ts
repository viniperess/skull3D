...
const createPathStrings = (filename: string): any => {
...
const createSkyBoxMaterial = async (filename: string): Promise<any> => {
...
const createSkyBox = async (filename: string, size: number): Promise<any> => {
